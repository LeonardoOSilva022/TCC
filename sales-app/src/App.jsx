...
import Profile from './components/Profile'; // NOVO IMPORT
...
export default function App() {
  ...
  // --- LÓGICA DE RASTREIO E E-MAIL ATUALIZADA ---
  const updateOrderStatus = (id, status) => {
    ...
    setOrders(prev => prev.map(o => {
      if (o.id === id) {
        // Adiciona a nova etapa à linha do tempo
    ...
    // SIMULAÇÃO DA AUTOMAÇÃO DE E-MAIL PARA A BANCADA VER
    setTimeout(() => {
  ...
  const updateUser = (userId, data) => {
    ...
    addLog(`Alteração de ${field} para o utilizador ID #${userId}`);
    showToast("Dados da equipa atualizados!");
  };
  ...
  const MENU_ITEMS = [
    ...
    { id: 'profile', label: 'O Meu Perfil', icon: UserCircle }, // NOVO MENU
  ];
